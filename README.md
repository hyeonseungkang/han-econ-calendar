...
FETCH_QUERY_FORMAT="start_date=$START_DATE&end_date=$END_DATE&sort_code=0&str_nation=$STR_NATION&str_natcd=$STR_NATCD&str_importance=3|2|1|"
FETCH_QUERY_STR_NATION_CANDIDATE="China,중국|Hong Kong,홍콩|India,인도|Indonesia,인도네시아|Japan,일본|Philippines,필리핀|Saudi Arabia,사우디아라비아|Singapore,싱가포르|South Korea,대한민국|Taiwan,대만|Vietnam,베트남|Euro Area,유럽연합|France,프랑스|Germany,독일|Greece,그리스|Italy,이탈리아|Russia,러시아|Switzerland,스위스|Turkey,터키|United Kingdom,영국|Brazil,브라질|Canada,캐나다|Mexico,멕시코|United States,미국|Australia,오스트레일리아|New Zealand,뉴질랜드|Egypt,이집트|South Africa,남아공"
FETCH_QUERY_STR_NATCD_CANDIDATE="cn|hk|in|id|jp|ph|sa|sg|kr|tw|vn|eu|fr|de|gr|it|ru|ch|tr|gb|br|ca|mx|us|au|nz|eg|za"
```